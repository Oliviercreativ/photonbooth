...
export default defineEventHandler(async (event) => {
  ...
  const prompts = {
    ...
    'aura-glow-pure-original': highQuality
      ? `Keep the person(s) looking like themselves but styled as DreamWorks 3D animated characters. Maintain their facial features, hair color, and personal characteristics while adding stylized cartoon features, large expressive eyes, simplified facial features, and the signature DreamWorks animation style. Add a bright orange-yellow aura/halo around their entire body, hair, and silhouette creating a luminous glowing effect. Keep the original background exactly as it appears in the photo - do not modify or transform the background environment. If multiple people are present, position them naturally together showing their interactions and relationships.`
      : `Transform person(s) into DreamWorks characters with aura, keep original background`,
    ...
    'cites-or-transformed': highQuality
      ? `Transform EVERYTHING into a Mysterious Cities of Gold style with Pixar 3D background. Keep the person(s) looking like themselves but adapt their appearance to Cities of Gold characters - large expressive eyes, clean bold outlines, flat coloring, and classic 1980s anime style. Maintain their facial features, hair color, and personal characteristics while adding the Cities of Gold costume - simple tunics in earthy colors (orange, yellow, green, blue), golden medallions, and adventure accessories. Make their eyes large and expressive like anime characters. Transform the ENTIRE background into a Pixar 3D animated environment - convert all walls, furniture, objects, and details into Pixar 3D style with vibrant colors, soft lighting, and plastic material look. Make the background look like it's from a Pixar movie with golden temples, ancient cities, and adventure landscapes. Everything must be in Pixar 3D animation style - both characters AND background.`
      : `Transform EVERYTHING into Cities of Gold style with Pixar 3D background`,
    
    'frozen-transformed': highQuality
      ? `Transform EVERYTHING into a Frozen (Queen of Snow) style with Pixar 3D background. Keep the person(s) looking like themselves but adapt their appearance to Frozen characters - large expressive eyes, soft elegant features, and classic Disney animation style. Maintain their facial features, hair color, and personal characteristics while adding the Frozen costume - elegant ice-blue dresses with shimmering patterns, sparkling accessories, snowflake jewelry, and royal attire. Make their eyes large and expressive like Elsa and Anna with soft makeup and gentle expressions. Style their hair elegantly like Frozen characters - braids, flowing styles, or elegant updos. Transform the ENTIRE background into a Pixar 3D animated environment - convert all walls, furniture, objects, and details into Pixar 3D style with vibrant colors, soft lighting, and plastic material look. Make the background look like it's from a Pixar movie with ice palaces, snowy landscapes, magical winter forests, and sparkling ice crystals. Everything must be in Pixar 3D animation style - both characters AND background.`
      : `Transform person(s) into Frozen style with Pixar 3D background`,
    
    // K-pop Pure Options
    'kpop-pure-original': highQuality
      ? `Keep the person(s) looking like themselves but styled as K-pop idols. Maintain their facial features, hair color, and personal characteristics while adding perfect K-pop makeup, stylish outfits, and glamorous poses. Enhance them with flawless skin, dramatic eye makeup, trendy fashion, and confident poses - but they should still look like themselves. Keep the original background unchanged. If multiple people are present, position them naturally together showing their interactions and relationships.`
      : `Transform person(s) into K-pop style while keeping their appearance, keep original background`,
    
    'kpop-pure-transformed': highQuality
      ? `Transform EVERYTHING into a K-pop music video scene. Keep the person(s) looking like themselves but styled as K-pop idols. Maintain their facial features, hair color, and personal characteristics while adding perfect K-pop makeup, stylish outfits, and glamorous poses. Enhance them with flawless skin, dramatic eye makeup, trendy fashion, and confident poses - but they should still look like themselves. Transform the ENTIRE background into a K-pop music video set with stage lights, colorful backgrounds, and glamorous atmosphere. Transform EVERY object in the background - walls, furniture, decorations, everything must look like a K-pop music video production. If multiple people are present, position them naturally together showing their interactions and relationships.`
      : `Transform EVERYTHING into K-pop music video - keep person's appearance but K-pop styled`,
