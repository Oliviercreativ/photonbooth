...
export default defineEventHandler(async (event) => {
  ...
  const prompts = {
    ...
    'ghibli-belgium': highQuality
      ? `Transform the person into a charming Studio Ghibli-style character and place them in a delightful Belgian-themed environment. Create a stylized, hand-drawn animation character with the signature Ghibli features - large expressive eyes, simplified facial features, and warm personality. The character should be positioned in a Belgian celebration scene featuring the iconic Belgian flag (black, yellow, red vertical stripes), golden Belgian waffles with whipped cream, Belgian beer with foam, Belgian chocolate truffles, Belgian fries, and the Atomium structure in the background. Use the characteristic Ghibli color palette with soft pastels, warm earth tones, and gentle watercolor-like textures. The entire scene should look like it could be from a Studio Ghibli movie celebrating Belgian culture with authentic Belgian elements rendered in Ghibli's signature hand-painted animation style.`
      : `Transform person into Ghibli character in Belgian scene with flag, waffles, beer, chocolate, Atomium`,
    
    'ghibli-uk': highQuality
      ? `Transform the person into a charming Studio Ghibli-style character and place them in a delightful British-themed environment. Create a stylized, hand-drawn animation character with the signature Ghibli features - large expressive eyes, simplified facial features, and warm personality. The character should be positioned in a British celebration scene featuring the iconic Union Jack flag (red, white, blue), traditional British elements like Big Ben clock tower, red double-decker bus, black taxi cab, British tea service with scones and jam, fish and chips, and London landmarks in the background. Use the characteristic Ghibli color palette with soft pastels, muted greens, and gentle watercolor-like textures. The entire scene should look like it could be from a Studio Ghibli movie celebrating British culture with authentic British elements rendered in Ghibli's signature hand-painted animation style.`
      : `Transform person into Ghibli character in British scene with Union Jack, Big Ben, tea, fish and chips`,
    
    'ghibli-germany': highQuality
      ? `Transform the person into a charming Studio Ghibli-style character and place them in a delightful German Oktoberfest-themed environment. Create a stylized, hand-drawn animation character with the signature Ghibli features - large expressive eyes, simplified facial features, and warm personality. The character should be positioned in a German Oktoberfest celebration scene featuring the iconic German flag (black, red, yellow horizontal stripes), traditional German elements like beer steins with foam, pretzels, bratwurst sausages, sauerkraut, German beer hall with wooden tables, lederhosen and dirndl clothing elements, and Bavarian architecture in the background. Use the characteristic Ghibli color palette with soft pastels, warm earth tones, and gentle watercolor-like textures. The entire scene should look like it could be from a Studio Ghibli movie celebrating German Oktoberfest culture with authentic German elements rendered in Ghibli's signature hand-painted animation style.`
      : `Transform person into Ghibli character in Oktoberfest scene with German flag, beer steins, pretzels, bratwurst`,
    
    'ghibli-france': highQuality
      ? `Transform the person into a charming Studio Ghibli-style character and place them in a delightful French-themed environment. Create a stylized, hand-drawn animation character with the signature Ghibli features - large expressive eyes, simplified facial features, and warm personality. The character should be positioned in a French celebration scene featuring the iconic French flag (blue, white, red vertical stripes), traditional French elements like croissants, baguettes, French wine, cheese platter, the Eiffel Tower, French café with outdoor seating, and Parisian architecture in the background. Use the characteristic Ghibli color palette with soft pastels, warm earth tones, and gentle watercolor-like textures. The entire scene should look like it could be from a Studio Ghibli movie celebrating French culture with authentic French elements rendered in Ghibli's signature hand-painted animation style.`
      : `Transform person into Ghibli character in French scene with French flag, croissants, wine, Eiffel Tower`,
